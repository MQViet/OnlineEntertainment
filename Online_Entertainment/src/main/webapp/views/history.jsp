...
<section class="m-auto" style="margin-top: -30px;">
	<h4>
		<strong style="color: rgba(255, 255, 255, 0.7); margin-left: 10px;">Đã
			xem gần đây</strong>
	</h4>
	<hr class="bg-light" style="margin-top: -5px;" />
	<div class="row wow bounce">
		<c:forEach var="list" items="${videohis}">
			<div class="col-lg-3 col-md-4 mb-4">
				<div class="bg-image hover-overlay hover-zoom ripple"
					...
					<img style="width: 100%;"
						...
						class="img-fluid" /><a
						href="<c:url value = '/video?action=watch&id=${list.id}'/>"> <b
						class="mask" style="background-color: rgba(128, 128, 128, 0.233);"></b>
					</a>
